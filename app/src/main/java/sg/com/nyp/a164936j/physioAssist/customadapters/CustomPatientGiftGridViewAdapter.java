...
public class CustomPatientGiftGridViewAdapter extends BaseAdapter {
    ...
    public CustomPatientGiftGridViewAdapter(Context context, int[] mobileValues) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            Log.d(Config.TAG_CUSTOM_ADAPTER, "(CustomPatientGiftGridViewAdapter) in getView");
            imgPetal.setBackground(context.getDrawable(mobileValues[position]));
